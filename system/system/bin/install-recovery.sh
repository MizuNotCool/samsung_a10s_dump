#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/bootdevice/by-name/recovery:33554432:1f90d79b4d5dbb9b035586ff77e3f09a87b8cb1c; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/bootdevice/by-name/boot:33554432:e4bec94b1ea138496e3b0fa8caca058649d06e07 \
          --target EMMC:/dev/block/platform/bootdevice/by-name/recovery:33554432:1f90d79b4d5dbb9b035586ff77e3f09a87b8cb1c && \
