...
cat system/system/priv-app/SamSungCamera3/SamSungCamera3.apk.* 2>/dev/null >> system/system/priv-app/SamSungCamera3/SamSungCamera3.apk
rm -f system/system/priv-app/SamSungCamera3/SamSungCamera3.apk.* 2>/dev/null
...
cat system/system/priv-app/sticker/sticker.apk.* 2>/dev/null >> system/system/priv-app/sticker/sticker.apk
rm -f system/system/priv-app/sticker/sticker.apk.* 2>/dev/null
